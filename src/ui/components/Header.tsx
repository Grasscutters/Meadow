                ...
                <div className="Header">
                    {
                        !this.state.isMobile ? (
                            ...
                            <>
                                <AiOutlineMenu className={"Header_MenuBtn"} size={30} onClick={this.toggleMenu} />
                                <div className="Header_LinksMobile">
                                    <FaGithub size={30} onClick={() => window.open("https://github.com/Grasscutters")} />
                                    <FaDiscord size={30} onClick={() => window.open("https://discord.gg/T5vZU6UyeG")} />
                                </div>
                            </>
                        )
                    }
...

                {
                    this.state.isMobile && this.state.isMenuOpen ? (
                        <div className="Header_MobileMenu">
                            <div onClick={async () => await router.navigate("/")}>Home</div>
                            <div onClick={async () => await router.navigate("/downloads")}>Downloads</div>
                            <div onClick={async () => await router.navigate("/wiki")}>Wiki</div>
                            <div onClick={async () => await router.navigate("/features")}>Features</div>
                        </div>
                    ) : null
                }
            </>
